...
```
  ...
  <h1>Texto Cientifícos.</h1>
  
  ```
    Na verdade, O subdesenvolvimento não é a ausência de desenvolvimento,
         mas o produto de um tipo Universal de
        desenvolvimento mal conduzido.
        É a concentração abusiva de riqueza - sobretudo neste periodo histórico dominado pelo neocolonialismo
        capitalista, que foi o fator determinante do subdesenvolvimento de uma grande parte do mundo:
        As regiões dominantes sob a forma de colônias politicas diretas ou coloônias econômicas.
  ```
